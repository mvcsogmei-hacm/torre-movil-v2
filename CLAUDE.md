...
- **Tema oscuro** (17-ago-2026): conmutable con el botón luna/sol de Inicio, persistido en `torre-ajustes.tema`; overrides bajo `html[data-tema="oscuro"]`. Iconos superiores derechos en variante `.icon-btn.solid` (círculo tinta, icono claro). La hoja Inversiones ya no tiene botón superior derecho.
