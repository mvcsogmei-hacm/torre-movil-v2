...
- **Detalle de Pliego MVCS** (`screen-pliego`, título "Pliego MVCS"): hoja **`MVCS`** (antes `PLIEGO`), exportada como `INDICADORES.pliego`. Se abre desde "Ver ranking" y desde el acceso "Pliego MVCS".
